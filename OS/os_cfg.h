...
#define OS_MAX_EVENTS           120    /* Max. number of event control blocks in your application      */
...
#define OS_MAX_QS               110    /* Max. number of queue control blocks in your application      */
